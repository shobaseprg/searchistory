<template>
  <!-- モーダル時背景 -->
  <div
    @click="controlOpen(false, MODAL_TYPE.HISTORY_CREATE)"
  ...
  >
    <div class="z-[2] w-[80%] h-[80%] p-[1em] bg-white" @click="stopEvent">
      ...
      <mavon-editor
        ...
        v-model="content"
      />
      <button @click="registerHistory(userStore.uid, targetTopicStore.targetTopic.docID)">登録</button>

      <button @click="controlOpen(false, MODAL_TYPE.HISTORY_CREATE); clearForm();">閉じる</button>
    </div>
  </div>
</template>
